...
public class LabProcessController {
    ...
    @RequestMapping(value = "/sampleCollect", method = RequestMethod.GET)
    public String sampleCollectedPatient(Model model){
        List<InvoiceHasLabTest> invoiceHasLabTests = invoiceHasLabTestService.findByLabTestStateAndTestDonePlace(LabTestStatus.SAMPLECOLLECT, LabtestDoneHere.YES);
    ...
    //save Workesheet printed lab test
    @RequestMapping(value = "/saveWorkSheetPatient", method = RequestMethod.POST)
    public String saveWorksheetTakenPatient(@ModelAttribute SearchProcess searchProcess, RedirectAttributes attributes) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();

        // NEED TO CREATE WORK SHEET USING I-TEXT BUDDY
        //USING INVOICE NUMBER AND LAB TEST LIST
        ...
        for (InvoiceHasLabTest invoiceHasLabTest : searchProcess.getInvoiceHasLabTests()) {
            ...
            invoiceHasLabTest.setWorkSheetTakenUser(userService.findByUserName(authentication.getName()));
    ...
    @RequestMapping(value = "/worksheetPrinted", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/labTestResultEnterForm/{id}", method = RequestMethod.GET)
    ...
    // need to save result
    @RequestMapping(value = "/saveResultPatient", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/authorize/resultAuthorizeList", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/authorize/labTestAuthorizedForm/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/authorize/saveAuthorized", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/authorize/rejectAuthorized/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/afterResultAuthorizeList", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/labTestPrintForm/{id}", method = RequestMethod.GET)
...
/*        boolean isFlag = labTestService.createPdf(invoiceHasLabTest, context, request, response);
    ...
    // create search form
    @RequestMapping(value = "/searchReportFrom", method = RequestMethod.GET)
